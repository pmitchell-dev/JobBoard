...
app.post('/api/jobs/:id/generate/resume', async (req, res) => {
  try {
    ...
    const promptMessage = promptTemplate
      ...
      .replace(/\{\{skeleton\.contact\}\}/g, skeleton.contact || '')
